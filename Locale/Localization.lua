...
L.SPOTLIGHT_SETTINGS_BUTTON_TOOLTIP = 'Open Edit Mode and jump to the Spotlight anchor to move it. Use Player List to choose specific raid members (useful for Aug Evoker buffs like Prescience).'
