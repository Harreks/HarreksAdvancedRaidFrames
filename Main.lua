...
- make dispellable debuffs bigger on the frame, border dispell for private auras

- move menu building to the lib
- set up advancedui addon
- change menu building function to detect parent addon
]]